            ...
            <CardHeader className="space-y-6 pb-4 text-center">
              ...
              <div>
                <CardTitle className="text-3xl font-bold">
                  <span
                    className="animate-gradient-text bg-gradient-to-r from-violet-400 via-cyan-400 to-violet-400 bg-clip-text text-transparent"
                  >
                    FastClaw
                  </span>
                </CardTitle>
            ...
            <CardContent className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={config.port}
                  onChange={(e) =>
                    updateConfig({ port: parseInt(e.target.value) || 8080 })
                  }
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full rounded-md border border-zinc-700 bg-zinc-800/50 px-3 py-2 text-sm text-zinc-200 placeholder:text-zinc-500 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500 resize-none"
                />
                <p className="text-xs text-zinc-500">
              ...
              {launched ? (
                <div className="space-y-4 text-center py-4">
                  ...
                  <p className="text-sm text-zinc-400">
                    Your agent &quot;{config.agentName}&quot; is ready. Run{" "}
                    <code className="rounded bg-zinc-800 px-2 py-0.5 font-mono text-violet-400">
                      fastclaw start
                    </code>{" "}
                    to begin.
                  </p>
